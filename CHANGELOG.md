...
- Split long Gerber arcs for CAM compatibility.
...
- Draw text boxes, knockout text and dashed strokes on STEP silkscreen and solder mask.
...
- Apply IPC-2581 rotation before mirroring consistently so rotated bottom-side geometry and component placement exports stay aligned.
